...
bool TessellationShader::initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = initializeShader(device, hwnd, 
		L"../ClothSim/Engine/shaders/tessellation.vs", 
		L"../ClothSim/Engine/shaders/tessellation.hs", 
		L"../ClothSim/Engine/shaders/tessellation.ds", 
		L"../ClothSim/Engine/shaders/tessellation.ps");
	if(!result)
	{
		return false;
	}
